...
if __name__ == "__main__":
    ...
    output_path = "dmcb-dev/tests/cache/team.html"
    save_website(team_url, output_path)

    player_url = "https://www.spotrac.com/nba/player/_/id/8066/kawhi-leonard"
    output_path = "dmcb-dev/tests/cache/player.html"
    save_website(player_url, output_path)

    sportsws_url = "https://sports.ws/nba/stats"
    output_path = "dmcb-dev/tests/cache/sportsws.html"
    save_website(sportsws_url, output_path)

    bbref_url = "https://www.basketball-reference.com/leagues/NBA_2026_totals.html"
    output_path = "dmcb-dev/tests/cache/bbref.html"
